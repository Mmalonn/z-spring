...
public class ProveedorRestController {
	...
	public ResponseEntity<ProveedorDto> editarProveedor(@RequestBody ProveedorDto proveedorDto, @PathVariable Long id){
		ProveedorBo proveedor = new ProveedorBo();
		proveedor.setNombre(proveedorDto.getNombre());
		proveedor.setDireccion(proveedorDto.getDireccion());
		proveedor.setTelefono(proveedorDto.getTelefono());
		...
		return ResponseEntity.status(HttpStatus.ACCEPTED).body(proveedorDto);
	}
}
